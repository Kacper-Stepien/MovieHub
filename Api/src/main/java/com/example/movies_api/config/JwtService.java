...
public class JwtService {
    ...
    public String generateToken(
        ...
        return Jwts.builder()
                .setClaims(extractClaims)   // Dodaje dodatkowe dane (jeśli są przekazane).
    ...
    private Key getSingningKey() {
        byte[] keyBytes = Decoders.BASE64.decode(SECRET_KEY); // Dekoduje klucz zakodowany w Base64.
        return Keys.hmacShaKeyFor(keyBytes); // Tworzy klucz HMAC do podpisywania tokenów.
    }
}
